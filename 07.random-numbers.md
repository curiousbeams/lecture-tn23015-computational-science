...
check_answers(answer_9_01_1, answer_9_01_2, key="answer_9_01")
```
...
answer_9_01_1_sol1 = np.copy(meanx_sol1)
answer_9_01_2_sol1 = np.copy(varx_sol1)
...
check_answers(answer_9_02_1, answer_9_02_2, key="answer_9_02")
```
...
answer_9_02_1_sol2 = np.copy(meanxn_sol2)
answer_9_02_2_sol2 = np.copy(varxn_sol2)
...
check_answers(answer_9_03_1, key="answer_9_03")
```
...
answer_9_03_1_sol3 = np.copy(pi_est_sol3)
...
check_answers(answer_9_05_1, key="answer_9_05")
```
...
answer_9_05_1_sol6 = np.copy(msphere_sol6)
...
check_answers(answer_9_06_1, key="answer_9_06")
```
...
# print(1.5*np.pi)
answer_9_06_1_sol7 = np.copy(mspherelin_sol7)
