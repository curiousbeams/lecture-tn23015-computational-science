...
But wait a minute, a sum over an array of Booleans creates an integer number, something weird must be going on here?!
...
Calculate the mass of the sphere for the case of the linear increasing density using the methodology developed in
