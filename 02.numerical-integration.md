...
As is the case for any calculation in a computer, the first step is to break our continuous variable $x$ into list of numbers `x[i]` separated by (typically) fixed steps (know as [discretising](wiki:Discretization)), along with corresponding set of $y$ values $y[i]$:
...
answer_4_01_1 = answer_4_01_2 = None
if given(npts, x, y):
...
_Tip:_ If you have trouble with your exit condition on your while loop, it might be handy to include a code line `print("N %d eta %e" % (N,eta))` to keep track of what is going on in your code. This is an [elementary form](https://pythondebugging.com/articles/python-debugging-with-print-statements) of [debugging](wiki:Debugging).
...
answer_4_03_1 = answer_4_03_2 = answer_4_03_3 = None
if given(N, eta, integral):
    answer_4_03_1 = N
...
answer_4_06_1 = None
if given(d, t, v, y_2, z, trapezoid):
...
[scipy.integrate.simps](https://docs.scipy.org/doc/scipy/reference/generated/scipy.integrate.simps.html)
