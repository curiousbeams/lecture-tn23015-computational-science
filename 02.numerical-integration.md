...
Write code to implement Simpson's rule for the same integral as [](#ex_4_01), using 11 points (10 steps).
...
Rewrite your calculation of the integral using Simpson's rule from [](#ex_4_04) to be vectorised using numpy slicing and the function `np.sum()`. 
:::{hint}
